...
drop policy if exists action_proposals_self_select on public.action_proposals;
...
drop policy if exists action_proposals_self_insert on public.action_proposals;
...
drop policy if exists action_proposals_self_update on public.action_proposals;
